...
| A08 Data Integrity and Confidentiality Failures | A10 파일 업로드 |
| A09 Security Logging & Alerting Failures | A12 에러 처리/로깅 |
...
- **OWASP**: A06:2025 Insecure Design / A08:2025 Data Integrity and Confidentiality Failures
...
- **OWASP**: A01:2025 Broken Access Control (SSRF는 2025 개정에서 A01에 통합)
...
- **OWASP**: A02:2025 Security Misconfiguration, A09:2025 Security Logging & Alerting Failures, A10:2025 Mishandling of Exceptional Conditions
...
- [ ] 프록시/로드밸런서에서 `x-middleware-subrequest` 헤더 외부 주입 차단 (CVE-2025-29927)
