...
- **OWASP**: A01 Broken Access Control (SSRF, 2025 통합)
...
- **OWASP**: A02 Security Misconfiguration, A09 Security Logging & Alerting Failures, A10 Mishandling of Exceptional Conditions
...
- [ ] `x-middleware-subrequest` 등 내부 헤더 외부 노출 차단 (CVE-2025-29927, CVSS 9.1)
