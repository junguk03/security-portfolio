...
| OWASP 2025 | 본 문서 항목 |
|------------|-------------|
| A01 Broken Access Control | A02 인증, A03 인가/IDOR, A07 CSRF, A09 Path Traversal, A11 SSRF |
...
| A09 Logging and Alerting Failures | A12 에러 처리/로깅 |
| A10 Mishandling of Exceptional Conditions | A12 에러 처리/로깅 (일부) |
...
- **OWASP**: A01 Broken Access Control (SSRF는 2025부터 A01에 포함)
...
- **OWASP**: A02 Security Misconfiguration, A09 Logging and Alerting Failures, A10 Mishandling of Exceptional Conditions
...
- [OWASP Top 10 (2025)](https://owasp.org/Top10/2025/) *(현행 최신; 이전 버전: [2021](https://owasp.org/Top10/2021/))*
