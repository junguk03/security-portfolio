...
> **2026-01 기준 OWASP Top 10:2025** — 2021 대비 카테고리 코드/이름이 변경되었다. 주요 변화: SSRF가 A01(Broken Access Control)로 통합, Security Misconfiguration이 A02로 상향, Software Supply Chain Failures(A03)·Mishandling of Exceptional Conditions(A10)가 신규 추가.
...
| A10 Mishandling of Exceptional Conditions | A12 에러 처리/로깅 (부분적으로) |
...
- **OWASP**: A01 Broken Access Control (SSRF는 2025년부터 A01에 통합)
...
- [ ] Middleware에서 인증 우회 가능 경로 없는지 (외부에서 `x-middleware-subrequest` 헤더 주입으로 우회 가능 — CVE-2025-29927)
- [ ] App Router(RSC) 사용 시 Next.js 패치 버전 적용 (CVE-2025-55182 / CVE-2025-66478: CVSS 10.0 RCE, Next.js ≥ 15.5.7 / 16.0.7)
- [ ] 자체 호스팅(Node.js 서버) 시 WebSocket 처리 취약점 점검 (CVE-2026-44578: SSRF, CVSS 8.6)
...
# Python
pip-audit
safety scan          # Safety CLI v3+: check 명령은 deprecated
...
- [OWASP Top 10 (2025)](https://owasp.org/Top10/2025/) — 2026년 1월 공개, 이전 버전: [2021](https://owasp.org/www-project-top-ten/)
- [OWASP ASVS](https://owasp.org/www-project-application-security-verification-standard/) — 검증 표준
- [OWASP Cheat Sheet Series](https://cheatsheetseries.owasp.org/)
- [CWE Top 25 (2025)](https://cwe.mitre.org/top25/archive/2025/2025_cwe_top25.html) — 2025년 12월 공개 (CISA)
