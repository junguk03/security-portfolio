...
| A08 Software & Data Integrity Failures | A10 파일 업로드 |
| A09 Security Logging and Alerting Failures | A12 에러 처리/로깅 |
| A10 Mishandling of Exceptional Conditions | A12 에러 처리/로깅 |
...
- **OWASP**: A01 Broken Access Control (SSRF는 2025년부터 A01로 통합)
...
- **OWASP**: A02 Security Misconfiguration, A09 Security Logging and Alerting Failures, A10 Mishandling of Exceptional Conditions
...
- [ ] Middleware에서 인증 우회 가능 경로 없는지 (`x-middleware-subrequest` 헤더로 우회 불가 확인, CVE-2025-29927 CVSS 9.1)
...
- [ ] OIDC 외부 공급자(Apple, Azure 등) 활성화 시 ID 토큰 발급자(issuer) 검증 및 최신 버전 유지 (CVE-2026-31813)
...
- [OWASP Top 10 (2025)](https://owasp.org/Top10/2025/) — 2026년 1월 최종 출시
